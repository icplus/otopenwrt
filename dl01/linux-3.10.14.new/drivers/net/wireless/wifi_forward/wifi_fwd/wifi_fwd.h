...
extern bool (*wf_fwd_tx_check_hook) (void *adapter, struct net_device *tx_dev, struct sk_buff *skb);
...
extern bool RTMPQueryLookupRepeaterCliEntryMT (void *adapter, unsigned char *pAddr, bool bIsPad);
